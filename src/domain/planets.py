...
class PlanetsDataCollector:
    ...
    @staticmethod
    def find_planet_moon_by_position(planet_sorted_moon_data, position):
        try:
            return planet_sorted_moon_data[position]['mass']['massValue']
    ...
    def process_one_planet_data(self, planet_specific_data):
        ...
        smallest_moon_mass_value = self.find_planet_moon_by_position(sorted_moon_data, 0)
        biggest_moon_mass_value = self.find_planet_moon_by_position(sorted_moon_data, -1)
        second_smallest_moon_mass_value = self.find_planet_moon_by_position(sorted_moon_data, 1)
        data = {'name': planet_name, 'polarRadius': polar_radius,
                'smallest moon mass': smallest_moon_mass_value,
                'second smallest moon mass': second_smallest_moon_mass_value,
                'biggest moon mass': biggest_moon_mass_value}
        return data
