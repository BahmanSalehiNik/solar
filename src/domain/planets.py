...
class PlanetsDataCollector:
    ...
    def filter_moon_data(self,moon_id):
        moon_data = [item for item in self.solar_data['bodies'] if item.get("id")
                     in [moon_id, strip_accents(moon_id.lower())]]
        return moon_data
    ...
    def sort_planet_moons_data_by_mass(self, planet_moon_data):
        pass

    def find_planet_smallest_moon(self, planet_sorted_moon_data):
        pass

    def pre_process_planet_data(self, ):
        for p in self.planets_raw_data:
            pass
...
if __name__ == '__main__':
    ...
    print(p_data.extract_planet_moons_data(uranus_data))